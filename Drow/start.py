...
# defalult name:
hi = "\n[" + name + " ~]$ "   # приветствие перед каждой командой.
...
# Особые Значения:
must_not_be = ""          # содержимое которому содержимое файла не должно быть равно.
if_must_be_change_value = "Hello, World!" # если must_not_be равен значению от содержимого файла,
# то изменить значение на if_must_be_change_value.
