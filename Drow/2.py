...
def start_modul_cut(tmp):
    ...
    try:
        # ~ import os
        # ~ if(check_file("/home/cytoncode/projects/Terminal_beta_1/work/__pycache__/lib.cpython-39.pyc")):
        #    # ~ os.remove("/home/cytoncode/projects/Terminal_beta_1/work/__pycache__/lib.cpython-39.pyc")
        from work import lib
        lib = reload(lib)
        lib.main(tmp)
